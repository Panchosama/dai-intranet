System.register(['@angular/core', '@angular/platform-browser', '@angular/http', '@ng-bootstrap/ng-bootstrap', './app.component', './menu.component', './noticias.service', './noticias-list.component', './noticia-doc.component', './noticia-img.component', './noticia.component', './routing'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, http_1, ng_bootstrap_1, app_component_1, menu_component_1, noticias_service_1, noticias_list_component_1, noticia_doc_component_1, noticia_img_component_1, noticia_component_1, routing_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
