System.register(['@angular/core', '@angular/router', './noticias.service', './rxjs-operators'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (_1) {}],
        execute: function() {
            NoticiaComponent = (function () {
                //Constructor
                function NoticiaComponent(noticiasService, route, router) {
                    this.noticiasService = noticiasService;
                    this.route = route;
                    this.router = router;
                    this.mode = 'Observable';
                }
                NoticiaComponent.prototype.getNoticia = function (idnew) {
                    var _this = this;
            ...
            exports_1("NoticiaComponent", NoticiaComponent);
        }
    }
});
